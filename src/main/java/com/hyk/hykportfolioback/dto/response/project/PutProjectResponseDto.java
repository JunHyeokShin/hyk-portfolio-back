...
@Getter
public class PutProjectResponseDto extends ResponseDto {

  private PutProjectResponseDto() {
    super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
  }

  public static ResponseEntity<PutProjectResponseDto> success() {
    PutProjectResponseDto result = new PutProjectResponseDto();
